...
def create_training_data():
    ...
    for text in texts:
        ...
        for sent_idx, sent in enumerate(sentences):
            # locate sentence in the original text starting from start_char
            ...
            if match_pos == -1:
                ...
                if m:
                    ...
                    missing_sentences += 1
                    # do not abort; skip to next sentence
                    continue
            else:
                match_start = match_pos
                match_end = match_start + len(sent)

            # Try alignment with expand then contract
            ...
            if span is None:
                # Fallback: use overlapping tokens
            ...
            # move start_char forward to end of matched sentence and skip whitespace
